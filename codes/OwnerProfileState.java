...
public class OwnerProfileState implements AppUIState{

    //Singleton
    private static OwnerProfileState instance = new OwnerProfileState();
    ...
    public static OwnerProfileState instance() {
        return instance;
    }
